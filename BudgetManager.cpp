...
void BudgetManager::showBalanceFromSelectedPeriod()
{
    ...
    {
        cout  << endl << "Please enter start date from which the period will be calculated: " << endl;
        date1 = OperationOnDates::loadAndCheckDate();
        cout << endl << "Please enter end date to which the period will be calculated: " << endl;
